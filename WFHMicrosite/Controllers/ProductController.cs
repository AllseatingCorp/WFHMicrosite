...
namespace WFHMicrosite.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult Index(int id)
        {
            ...
            json = SendWebApiMessage(apiUrl + "productimages/" + data.User.ProductId + "/" + data.FabricId + "/" + data.MeshId, "GET", "");
            data.ProductImage = JsonConvert.DeserializeObject<ProductImageModel>(json);
        ...
        public IActionResult Index(UserProductModel data)
        {
            if (ModelState.IsValid)
            {
                ...
                if (update)
                {
                    string result = AddressValidation(data.User);
        ...
        public IActionResult ChairPartial(int product, int option1, int option2)
        {
            string apiUrl = configuration.GetValue<string>("AppSettings:ApiUrl");
            string json = SendWebApiMessage(apiUrl + "productimages/" + product + "/" + option1 + "/" + option2, "GET", "");
            ProductImageModel data = JsonConvert.DeserializeObject<ProductImageModel>(json);
        ...
        public IActionResult Complete(int id)
        {
            ...
            if (data.User.Shipped != null)
            {
                ...
                if (!string.IsNullOrEmpty(data.Product.TrackingNumber))
                    data.Status += " Your tracking number is " + data.Product.TrackingNumber;
                else
        ...
        private string AddressValidation(UserModel data)
        {
            string result = "";
